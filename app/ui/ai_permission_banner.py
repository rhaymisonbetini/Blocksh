...
class AiPermissionBanner(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        icon = QLabel("🤖")
        icon.setStyleSheet(f"background: transparent; border: none; font-size: {TY.lg}px;")
    ...
    def apply_theme(self, p: Palette) -> None:
        ...
        self._deny_btn.setStyleSheet(
            ...
            f" border: 1px solid {p.red}; border-radius: 4px; font-size: {TY.sm}px; }}"
